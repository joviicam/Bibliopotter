         ...
         <View style={styles.Container}>
               ...
               <View style={styles.prestamosContainer}>
                 {prestamos.map(prestamo => (
                   <Prestamos cliente={prestamo.nombrePersona} libro={prestamo.libro.titulo} idLibro={prestamo.idLibro} 
                     key={prestamo.idPrestamo}
                     onPress={() => {
                       navigation.navigate("PrestamosCrudS", {idPrestamo: prestamo.idPrestamo, nombrePersona: prestamo.nombrePersona, idLibro: prestamo.libro.idLibro, mode: "view"})
                     }}
                   />
                 ))}
               </View>
